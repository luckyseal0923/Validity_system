...
const CHECKLIST_QUESTIONS: RatingItem[] = [
  ...
  { id: 6, text: "正確使用 Ambu bagging 技巧，插管前充分給氧" },
  { id: 7, text: "執行壓額抬下巴法打開呼吸道" },
  { id: 8, text: "置入口鼻咽管以暢通呼吸道" },
  { id: 9, text: "給予或說明插管前驅藥物 LOAD" },
  { id: 10, text: "挑選適合 RSI 藥物並正確施打或清楚下達醫囑" },
  { id: 11, text: "左手拿喉頭鏡且施力方向正確" },
            ...
            <form onSubmit={handleSubmit} className="glass-card" id="expert-survey-form">
              ...
              <div className="survey-section">
                ...
                <div className="section-intro-card">
                  <AlertCircle className="intro-icon" size={20} />
                  <div>
                    請評估本考站整體設計是否能適切反映核心能力。評分採四分量表：<strong>1 = 非常不同意、2 = 不同意、3 = 同意、4 = 非常同意</strong>。其中 3 分與 4 分代表您同意該項目具適切性。若需要修改，請於下方修改建議說明。
                  </div>
                </div>
              ...
              <div className="survey-section">
                ...
                <div className="section-intro-card">
                  <AlertCircle className="intro-icon" size={20} />
                  <div>
                    請逐項審查下列 checklist 評分項目之適切性（是否具代表性、文字清楚、可現場觀察評分）。評分採四分量表：<strong>1 = 非常不適切、2 = 不適切、3 = 適切、4 = 非常適切</strong>。若建議修改，請詳細說明原因。
                  </div>
                </div>
